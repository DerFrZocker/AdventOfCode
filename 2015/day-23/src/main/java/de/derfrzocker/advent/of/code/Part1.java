...
public class Part1 {
    ...
    private static Map<Character, Integer> REGISTRIES = new HashMap<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(REGISTRIES.getOrDefault('b', 0));
    }
    ...
    private record JieInstruction(char registry, int offset) implements Instruction {
        ...
        @Override
        public int execute() {
            int result = REGISTRIES.getOrDefault(registry, 0);
